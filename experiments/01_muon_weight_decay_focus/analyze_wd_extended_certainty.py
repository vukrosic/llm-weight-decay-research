...
RUNS_DIR = Path("experiments/01_muon_weight_decay_focus/runs/wd_extended_certainty")
OUT_DIR = RUNS_DIR


def parse_run(name: str):
    # wdm0p01_seed42 or wd0p0_seed137
...
def main():
    ...
    plt.title("Extended Certainty: mean ± std over seeds")
    ...
    plt.title("Extended Certainty: real impact vs baseline")
    for i, b in enumerate(bars):
        plt.text(
    ...
    with open(report, "w") as f:
        f.write("# Extended Certainty WD Report\n\n")
