...
GEN_DIR="${BASE_DIR}/generated_configs/wd_longer_certainty"
RUNS_DIR="${BASE_DIR}/runs/wd_longer_certainty"

TRAIN_TOKENS="${TRAIN_TOKENS:-8000000}"
MUON_LR="${MUON_LR:-0.024}"
NUM_WORKERS="${NUM_WORKERS:-0}"
WDS=("-0.01" "0.0" "0.01")
SEEDS_CSV="${SEEDS_CSV:-42,137,256}"
...
python experiments/01_muon_weight_decay_focus/analyze_wd_longer_certainty.py
echo "Longer certainty experiment complete."
